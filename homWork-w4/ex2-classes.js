...
class Wallet {
  ...
  constructor(name, cash) {
    this.#name = name;
    this.#cash = cash;
    this.#dailyAllowance = 40; // Default value for daily allowance
    this.#dayTotalWithdrawals = 0; // Initialize dayTotalWithdrawals to zero
  }
  ...
  // New method to reset dayTotalWithdrawals to zero
  resetDailyAllowance() {
